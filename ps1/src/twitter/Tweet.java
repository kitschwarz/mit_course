...
public class Tweet {
     ...
     * @param author
     *            Twitter username who wrote this tweet. Required to be a
     ...
     *         nonempty sequence of letters (A-Z or a-z), digits, underscore
     *         ("_"), or hyphen ("-"). Twitter usernames are case-insensitive,
     *         so "jbieber" and "JBieBer" are equivalent.
     */
